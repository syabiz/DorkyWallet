...
export default class Azteco {
   ...
   * @param {string} address - Dorkcoin address to send the redeemed bitcoin to.
   *
  ...
  static async redeem(voucher: AztecoVoucher, address: string): Promise<boolean> {
    ...
    const url = `${baseURI}dorky_despatch.php?CODE_1=${voucher.c1}&CODE_2=${voucher.c2}&CODE_3=${voucher.c3}&CODE_4=${voucher.c4}&ADDRESS=${address}`;
