...
const dirsToInterate = ['components', 'screen', 'dorky_modules', 'class', 'hooks', 'helpers', 'navigation', 'typings'];
const addFiles = ['DorkyComponents.tsx', 'App.tsx', 'navigation/index.tsx'];
