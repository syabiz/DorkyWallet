...
import { joinQRs, splitQRs } from '../../dorky_modules/bbqr/main';
import { base64ToUint8Array, uint8ArrayToBase64, uint8ArrayToString } from '../../dorky_modules/uint8array-extras';
import * as bitcoin from 'bitcoinjs-lib';
import { DorkyURDecoder } from '../../dorky_modules/ur';
...
describe('DorkyURDecoder', () => {
  it('can import wallet descriptor from coldcard q', async () => {
    const decoderPartial = new DorkyURDecoder();
