...
class CustomReporter {
  ...
  onTestCaseResult(test, testCaseResult) {
    ...
    if (testCaseResult.fullName.includes('DorkyElectrum can do multiGetBalanceByAddress(), disableBatching=')) return;
    ...
    if (testCaseResult.fullName.includes('txdatas were coming back null from DorkyElectrum because of high batchsize')) return;
